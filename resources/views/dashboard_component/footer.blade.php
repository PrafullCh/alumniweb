...
<script src="{{asset('public/admin-assets/js/plugins/fullcalendar.min.js')}}"></script>
...
<script src="{{asset('public/admin-assets/js/material-dashboard.js?v=2.1.1')}}" type="text/javascript"></script>{{--
<!-- Material Dashboard DEMO methods, don't include it in your project! -->--}}
<script src="{{asset('public/js/gallery.js')}}" type="text/javascript"></script>{{--
